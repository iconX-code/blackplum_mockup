...
:root {
  ...
  --color-accent-purple-soft: var(--color-purple-soft);
...
:root {
  ...
  --landing-tagline-font-size:           clamp(var(--size-32), 10vw, var(--font-size-display-lg));
  ...
  /* OriginInfo thumb */
  --origin-thumb-size:          var(--card-thumb-size);        /* alias — 56px, 의미 분리 */
